...
<p align="center">
  <em>Bacharel em Sistemas de Informação (UFV) | Information Systems B.S. (UFV)</em>
</p>

---

### 🇧🇷 Sobre Mim
- 🎓 **Acadêmico:** Mestrando na **UFMG** (2026.1). Bacharel pela **UFV-CRP**.
- 📚 **Pesquisa:** Pesquisador com 10 artigos publicados. Foco em Algoritmos e Estruturas de Dados.
- 💻 **Dev:** Entusiasta de Backend, Cibersegurança e UX Design. 
- 🎮 **Game Dev:** Desenvolvedor do projeto "Palavras ao Ar".
- ♟️ **Hobbies:** Enxadrista, gamer e "pai de planta" (cultivando de manjericão a limoeiros).

### 🇺🇸 About Me
- 🎓 **Academic:** MSc Student in Computer Science at **UFMG**. B.S. in Information Systems from **UFV**.
- 📚 **Research:** Researcher with 10 published papers. Focused on Algorithms and Data Structures.
- 💻 **Dev:** Enthusiastic about Backend, Cybersecurity, and UX Design.
- 🎮 **Game Dev:** Creator of the "Palavras ao Ar" educational game.
- ♟️ **Hobbies:** Chess player, gamer, and plant lover (tending to everything from basil to lemon trees).
...
<div align="center">
  ...
  <img src="https://img.shields.io/static/v1?message=UX%20Design&label=&color=2C3E50&style=for-the-badge" alt="UX Design" />
  <img src="https://img.shields.io/static/v1?message=Network%20Security&label=&color=2C3E50&style=for-the-badge" alt="Network Security" />
  <img src="https://img.shields.io/static/v1?message=IoT&label=&color=2C3E50&style=for-the-badge" alt="IoT" />
  <img src="https://img.shields.io/static/v1?message=Serious%20Games&label=&color=2C3E50&style=for-the-badge" alt="Serious Games" />
